...
INSERT INTO sponsorship_item (id, category, title, default_amount, sort_order, is_active, created_at) VALUES
  ...
  ('murti-saree', 'Murti', 'Murti Saree', NULL, 130, 1, unixepoch()),
  -- Stage
  ('murti-moncha', 'Stage', 'Pratima/Murti Mancha', 100000, 200, 1, unixepoch()),
  ('cultural-background-flex', 'Stage', 'Cultural Background Flex', NULL, 210, 1, unixepoch()),
  -- Bhog
  ...
  ('ashtami-bhog-1', 'Bhog', 'Ashtami Bhog 1', 20000, 330, 1, unixepoch()),
  ('ashtami-bhog-2', 'Bhog', 'Ashtami Bhog 2', 20000, 335, 1, unixepoch()),
  ...
  ('lakshmi-pujo-bhog', 'Lakshmi Puja', 'Lakshmi Pujor Bhog', 10000, 800, 1, unixepoch()),
  -- Puja
  ...
  ('ashtami-puja-1', 'Puja', 'Ashtami Puja 1', 5000, 460, 1, unixepoch()),
  ('ashtami-puja-2', 'Puja', 'Ashtami Puja 2', 5000, 465, 1, unixepoch()),
  ('ashtami-puja-3', 'Puja', 'Ashtami Puja 3', 5000, 470, 1, unixepoch()),
  ('ashtami-puja-4', 'Puja', 'Ashtami Puja 4', 5000, 475, 1, unixepoch()),
  ('ashtami-puja-5', 'Puja', 'Ashtami Puja 5', 5000, 480, 1, unixepoch()),
  ...
  ('cultural-prizes', 'Cultural', 'Prizes & Awards (Kids'' Cultural Events)', NULL, 860, 1, unixepoch()),
